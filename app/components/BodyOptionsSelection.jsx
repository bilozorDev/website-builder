...
import NewsletterDataInputs from "@/app/components/newsletter/NewsletterDataInputs";
                ...
                {hero.display ? (
                    <Disclosure as="div" className="">
                        {({open}) => (
                            <>
                                <DisclosureButton
                                    className="w-full border-b pb-2 text-left flex items-center">Settings <ChevronDownIcon
                                    className={clsx('w-5 ml-4', open && 'rotate-180')}/></DisclosureButton>
